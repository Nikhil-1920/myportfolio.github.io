var cursor = {
  ...
  delay: 8, _x: 0, _y: 0, endX: window.innerWidth / 2,
  ...
  setupEventListeners: function() {
    ...
    document.addEventListener("mousemove", function(element) {
   
      self.cursorVisible = true; self.toggleCursorVisibility();

      self.endX = element.pageX;
      self.endY = element.pageY;
